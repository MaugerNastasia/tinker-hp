...
c          tagmpi = iproc + 1
c          call MPI_ISEND(x,n,MPI_REAL8,iproc,tagmpi,COMM_TINKER,
c     $    req(tagmpi),ierr)
c        end do
c      else
c        tagmpi = rank + 1
c          call MPI_IRECV(x,n,
c     $     MPI_REAL8,0,tagmpi,COMM_TINKER,req(tagmpi),ierr)
c      end if
c      if (rank.eq.0) then
c        do iproc = 1, nproc-1
c          tagmpi = iproc + 1
...
c        do iproc = 1, nproc-1
c          tagmpi = iproc + 1
c          call MPI_ISEND(y,n,MPI_REAL8,iproc,tagmpi,COMM_TINKER,
c     $    req(tagmpi),ierr)
c        end do
c      else
c        tagmpi = rank + 1
...
c        do iproc = 1, nproc-1
c          tagmpi = iproc + 1
c          call MPI_ISEND(z,n,MPI_REAL8,iproc,tagmpi,COMM_TINKER,
c     $    req(tagmpi),ierr)
c        end do
c      else
c        tagmpi = rank + 1
